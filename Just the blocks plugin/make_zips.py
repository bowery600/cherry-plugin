...
ROOT = os.path.dirname(os.path.abspath(__file__))          # .../wordpress/Just the blocks plugin
WORKSPACE = os.path.dirname(ROOT)                           # .../wordpress

# (source_dir, output_zip, set_of_top_level_names_to_exclude)
JOBS = [
    (os.path.join(WORKSPACE, "Just the theme", "cherrystone-theme"),
     os.path.join(WORKSPACE, "cherrystone-theme.zip"),
     set()),
    (os.path.join(ROOT, "cherrystone-blocks"),
     os.path.join(WORKSPACE, "cherrystone-blocks.zip"),
